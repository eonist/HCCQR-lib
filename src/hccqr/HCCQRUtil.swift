...
public class HCCQRUtil{
    ...
    */
   public static func getHCCQRImage(string str:String, qrVersion:Int, qrMode:QRMode, ecLevel:ECLevel, scale:Int, onComplete: @escaping (UIImage?)->Void)  {
...
//         Swift.print("Time to get string: \(abs(startTime.timeIntervalSinceNow))")
    ...
    */
   public static func stringAndImages(uiImage:UIImage, onComplete:@escaping StringAndImageComplete){
