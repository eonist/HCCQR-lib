...
extension CVBufferTest {
   ...
   static func onWriteComplete(result: Result<Image, Error>, data randomData: Data, onComplete: @escaping OnComplete) {
      ...
      HCCQRReader.dataAndImages(rgbaImage: rgbaImage) { result in // try to split the HCCQRImg
...
extension CVBufferTest {
    ...
    */
   private static func onReadComplete(result: HCCQRReader.DataAndImagesResult, randomData: Data, onComplete: @escaping OnComplete) {
