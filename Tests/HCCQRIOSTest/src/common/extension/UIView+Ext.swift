...
extension UIView {
   ...
   var snapShot: UIImage? {
      UIGraphicsBeginImageContextWithOptions(self.frame.sizeDEPRECATED, false, 0) /*<-scale*/
    ...
    */
   func createLayer(color: UIColor, sizeDEPRECATED: CGSize = .init(width: 100, height: 100)) -> CALayer {
      let layer: CALayer = .init()
      layer.frame = .init(origin: .zero, sizeDEPRECATED: sizeDEPRECATED)
