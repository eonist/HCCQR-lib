...
extension PhotoTest {
   ...
   internal static func test() -> Bool {
      ...
      guard let data: Data = try? Reader.data(rgbaRep: rgbaRep, pallete: .pallete(pallete: ._4, darkMode: true)).qrData else { Swift.print("err"); return false }// extract data from the hccqrImg
