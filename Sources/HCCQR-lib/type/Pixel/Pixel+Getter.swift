...
extension Pixel {
    ...
    * - Fixme: ⚠️️ How similar is a color, figure out 0 - 1 how strong a color is, remember channels can be fractional when we start using other colors than R, B, G
    ...
    * - Fixme: ⚠️️⚠️️ Move to PixelParser?
    * - Note: Is only used by ChannelAssert
