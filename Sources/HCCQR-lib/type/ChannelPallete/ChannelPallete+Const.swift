...
extension ChannelPallete {
    ...
    */
   static let _4: ChannelPallete = [.white, .red, .green, .blue]
   /**
    ...
    */
   static let _8: ChannelPallete = .dynamicColors(r: 2, g: 2, b: 2) // [.white, .red, .green, .blue, .cyan, .magenta, .yellow, .black]
   /**
    * 16 Colors
    * - Note: R takes 4 values, 0, 85, 170 and 255, and the channel G and B take two values, 0 and 255
    */
   static let _16: ChannelPallete = .dynamicColors(r: 4, g: 2, b: 2)
   /**
    * 32 Colors
    ...
    */
   static let _32: ChannelPallete = .dynamicColors(r: 4, g: 4, b: 2)
   /**
    * 64 Colors
    ...
    */
   static let _64: ChannelPallete = .dynamicColors(r: 4, g: 4, b: 4)
   /**
    * 128 Colors
    ...
    */
   static let _128: ChannelPallete = .dynamicColors(r: 8, g: 4, b: 4)
   /**
    * 256 Colors
    ...
    */
   static let _256: ChannelPallete = .dynamicColors(r: 8, g: 8, b: 4)
}
