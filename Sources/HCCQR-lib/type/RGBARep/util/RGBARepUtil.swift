...
//   private static func rgbaRepresentation(cgImage: CGImage) throws -> RGBARep {
      // 🏀
      // add new init code and benchmark
      // figure out how to read pixels x,y by looping from linear array, prob: idx % height, and adding +1 to X value, test with extract method probably
//   }
}
