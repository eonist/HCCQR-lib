...
extension ChannelScheme {
    ...
    */
   public static let cs4: ChannelScheme = [.white, .red, .green, .blue]
   /**
    ...
    */
   public static let cs8: ChannelScheme = .dynamicColors(r: 2, g: 2, b: 2) // [.white, .red, .green, .blue, .cyan, .magenta, .yellow, .black]
   /**
    * 16 Colors
    * - Note: R takes 4 values, 0, 85, 170 and 255, and the channel G and B take two values, 0 and 255
    */
   public static let cs16: ChannelScheme = .dynamicColors(r: 4, g: 2, b: 2)
   /**
    * 32 Colors
    ...
    */
   public static let cs32: ChannelScheme = .dynamicColors(r: 4, g: 4, b: 2)
   /**
    * 64 Colors
    ...
    */
   public static let cs64: ChannelScheme = .dynamicColors(r: 4, g: 4, b: 4)
   /**
    * 128 Colors
    ...
    */
   public static let cs128: ChannelScheme = .dynamicColors(r: 8, g: 4, b: 4)
   /**
    * 256 Colors
    ...
    */
   public static let cs256: ChannelScheme = .dynamicColors(r: 8, g: 8, b: 4)
}
