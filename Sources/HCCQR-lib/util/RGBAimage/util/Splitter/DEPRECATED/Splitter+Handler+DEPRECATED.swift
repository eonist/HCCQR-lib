...
extension Splitter {
    ...
    */
//   static func onChannelsCompleteDEPRECATED(result: Channel.ChannelsResult, onComplete:@escaping SplitPayloadCompleted) { // called when the (R,G,B) channels are split
...
//   }
    ...
    * - Fixme: ⚠️️⚠️️⚠️️ Possibly deprecate, since we use GrayScale version of this now
    */
//   static func onCompositeCompleteDEPRECATED(i: Int, qrImg: CIImage?, qrImgs: inout [CIImage?], channels: Channel.RGBAImages, onComplete: SplitPayloadCompleted) {
