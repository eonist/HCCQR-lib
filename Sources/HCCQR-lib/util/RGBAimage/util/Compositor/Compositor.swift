...
final class Compositor {
   ...
   static func composite(first: RGBAImage, second: RGBAImage) throws -> CIImage {
      let rgbaImg: RGBAImage = try composite(rgbaImages: [first, second], invert: true)
    ...
    */
   /*private */static func composite(rgbaImages: [RGBAImage], invert: Bool) throws -> RGBAImage {
