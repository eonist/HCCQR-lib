...
extension Extractor {
   /**
    * Split an RGBRep 👉 many GrayRep's consisting of singular color channels
    * 1. RGBRep comes in with a ChannelMap rule-set ()
...
extension Extractor {
    ...
    * - Note: this method is verbose because else it throws syntaxt warning
